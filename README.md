...
```bash
python -m pytest -q
python main.py --turns 2 --difficulty normal --empire-name "My Empire"
python -m compileall main.py standalone_app.py strategy_game
```

Note: launching `python standalone_app.py` requires a graphical desktop environment.
